...
Captura áudio do microfone com Voice Activity Detection (VAD)
e segmentação inteligente para processamento em tempo real.
"""
...
class AudioConfig:
    ...
    min_speech_duration_ms: int = 300  # Mínimo de fala para considerar
    max_speech_gap_ms: int = 800  # Máximo de silêncio entre falas
